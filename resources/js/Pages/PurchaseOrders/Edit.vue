    ...
    <AppLayout>
        <template #header>
            <div class="flex justify-between items-center">
                <div>
                    <h2 class="text-2xl font-semibold text-gray-900">Edit Purchase Order: {{ purchaseOrder.po_number }}</h2>
        ...
        <div class="py-6">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <!-- Error Message if cannot edit -->
                <div v-if="!canEdit(purchaseOrder)" class="mb-4 p-4 bg-red-100 border border-red-400 text-red-700 rounded">
                    This purchase order cannot be edited because it's already {{ formatStatus(purchaseOrder.status) }}.
...
const form = useForm({
    ...
    order_date: new Date(props.purchaseOrder.order_date).toISOString().split('T')[0],
    expected_delivery_date: props.purchaseOrder.expected_delivery_date 
        ? new Date(props.purchaseOrder.expected_delivery_date).toISOString().split('T')[0] 
        : '',
    shipping_address: props.purchaseOrder.shipping_address || '',
    notes: props.purchaseOrder.notes || '',
    shipping_cost: parseFloat(props.purchaseOrder.shipping_cost) || 0,
    tax_amount: parseFloat(props.purchaseOrder.tax_amount) || 0,
...
const onSupplierChange = () => {
    ...
    if (supplier && supplier.address && !form.shipping_address) {
...
const onProductChange = (index) => {
    ...
    if (product) {
        ...
        form.items[index].unit_cost = parseFloat(product.cost_price) || form.items[index].unit_cost;
