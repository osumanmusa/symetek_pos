        ...
        <div class="bg-white rounded-lg shadow p-4">
          <div class="flex items-center">
            ...
            <div class="ml-4">
              ...
              <p class="text-2xl font-bold text-gray-900">${{ stats.today_sales.toFixed(2) }}</p>
            </div>
          </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-4">
          <div class="flex items-center">
            ...
            <div class="ml-4">
              ...
              <p class="text-2xl font-bold text-gray-900">${{ stats.month_sales.toFixed(2) }}</p>
            </div>
          </div>
        </div>
        ...
        <table class="min-w-full divide-y divide-gray-200">
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            <tr v-for="sale in sales.data" :key="sale.id" class="hover:bg-gray-50">
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                <div class="text-lg font-bold text-gray-900">${{ sale.total_amount.toFixed(2) }}</div>
                <div class="text-xs text-gray-500">
                  Paid: ${{ sale.amount_paid.toFixed(2) }}
                </div>
              </td>
              <td class="px-6 py-4">
...
const getProductNames = (items) => {
  ...
  const names = items.slice(0, 2).map(item => item.product?.name)
