            ...
            <form @submit.prevent="submit">
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <TextInput
                    ...
                    class="mt-1 block w-full"
                  />
                  <InputError :message="errors.contact_person" class="mt-2" />
                </div>
              ...
              <div class="flex items-center justify-end mt-8">
                ...
                >
                  ...
                  <span v-else>{{ isEdit ? 'Update' : 'Create' }} Warehouse</span>
                </PrimaryButton>
              </div>
            </form>
          </div>
...
const formTitle = computed(() => isEdit.value ? 'Edit Warehouse' : 'Create New Warehouse')
