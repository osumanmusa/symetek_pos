<!-- resources/js/Components/Layout/AlertMessages.vue -->
<template>
    <div v-if="hasFlashMessages" class="mb-6 space-y-4">
        ...
        <div v-if="$page.props.flash.info" 
             class="bg-blue-50 border-l-4 border-blue-400 p-4 rounded-md">
            <div class="flex items-center">
                <div class="flex-shrink-0">
